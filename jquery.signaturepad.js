...
function SignaturePad (selector, options) {
  ...
  function generateConstantMatrix (sampledPoints) {
  ...
  function convertBSplineControlPointsToBezierControlPoints (BSplinePoints) {
  ...
  function getBezierControlPoints (sampledPoints) {
